...
```typescript
import { registerContentTokenProfileConfiguration } from "genai-lite";
...
- **[Constrained Answer Labels](./genai-lite-docs/constrained-answer-labels.md)** - Label grammars, probability evidence, and optional shared-prefix resolution
