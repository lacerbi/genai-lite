...
### package.json
## Purpose
This package.json file configures genai-lite v0.17.3, a lightweight and portable toolkit designed to provide a unified interface for interacting with various Generative AI APIs. The package is published under the MIT license and maintained by Luigi Acerbi.
