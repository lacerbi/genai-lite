...
- `contentProfiles.ts`: Transactional startup registry, canonical semantic revisions, exact aliases, model-quality callbacks, and deterministic runtime mapping provenance.
