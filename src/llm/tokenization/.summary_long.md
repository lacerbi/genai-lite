...
Registration is transactional and freezes on first content read. Exact
case-sensitive aliases, canonical semantic provenance, optional runtime package
provenance, and a deterministic mapping revision are kept distinct from the
