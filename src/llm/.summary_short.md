...
- `LLMService.ts`: Orchestrates canonical preparation/dispatch, revision-authoritative state reuse, stale checks, streaming, scope-keyed answer evidence, and exact/model content-profile capability and raw-content accounting.
