...
canonical semantic-revision computation, transactional startup registration,
exact alias resolution, synchronous content counting, and runtime mapping
revision inspection. Optional loader and recipe values intentionally live on
separate package subpaths so importing the root never loads the optional
tokenizer peer.
